...
export default defineComponent({
  ...
  setup: function (props, { emit, expose }) {
    ...
    function registerPlayPauseButton() {
      ...
      shakaControls.registerElement('ft_play_pause', new PlayPauseButtonFactory())
    }
    ...
    function registerQualityButton() {
      class QualityButtonFactory {
        create(rootElement, controls) {
          return new QualityButton(rootElement, controls)
        }
      }
      shakaControls.registerElement('ft_quality', new QualityButtonFactory())
    }
    ...
    function keyboardShortcutHandler(event) {
      ...
      switch (event.key.toLowerCase()) {
        ...
        case KeyboardShortcuts.VIDEO_PLAYER.PLAYBACK.LARGE_REWIND:
          ...
          event.preventDefault()
          seekBySeconds(-defaultSkipInterval.value * 2, false, true)
          break
        ...
        case KeyboardShortcuts.VIDEO_PLAYER.PLAYBACK.SMALL_REWIND:
          ...
          if (canChapterJump(event)) {
            ...
            seekBySeconds(-defaultSkipInterval.value, false, true)
          }
          break
